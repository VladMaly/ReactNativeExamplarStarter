#Personal Notes:
#- Using Expo for launching/testing project, launch the app on any Android or Iphone and enter the link provided upon npm start.
#- Using React Navigation library for navigating.
#- Using React native elements library(Cross platform React Native UI Toolkit, essentially icons and button styles and so on)
